...
1. **Lack of Clarity**  
   Gives vague answers and cannot explain the steps clearly.
2. **Avoiding Decisions**  
   Does not take decisions and keeps waiting for instructions.
3. **No Ownership**  
   Does not try to solve the problem and depends fully on others.
